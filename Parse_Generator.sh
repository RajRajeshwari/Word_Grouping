...
#cd $HOME/Word_Grouping

sh $hindi_parser/run_hindi_parser.sh $HOME/tmp_anu_dir/tmp/test_tmp/2.1/H_sentence $HOME/tmp_anu_dir/tmp/test_tmp/2.1/hindi_parser_canonial.dat
